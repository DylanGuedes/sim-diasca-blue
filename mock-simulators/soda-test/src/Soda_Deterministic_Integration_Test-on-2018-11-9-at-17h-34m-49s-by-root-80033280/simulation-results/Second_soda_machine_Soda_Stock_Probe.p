...
set output "Second_soda_machine_Soda_Stock_Probe.png"
plot  "Second_soda_machine_Soda_Stock_Probe.dat" using 1:2 title "Second soda machine can stock" noenhanced
