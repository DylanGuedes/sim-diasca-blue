...
% Describes options that apply to probes.
%
-record( probe_options, {
		   ...
		   % change in the rendering parameter, but remaining available even if
		   ...
		   %
		   probe_directory = undefined :: file_utils:directory_name()
