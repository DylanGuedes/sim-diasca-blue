...
construct( State, ?wooper_construct_parameters ) ->
	...
	naming_utils:register_as( ?resilience_agent_name, ?registration_type ),
...
destruct( State ) ->
	...
	naming_utils:unregister( ?resilience_agent_name, ?registration_type ),
...
recoverNodes( State, NodesToRecover, Tick, Diasca ) ->
	...
	LocalInstanceTracker = naming_utils:get_registered_pid_for(
