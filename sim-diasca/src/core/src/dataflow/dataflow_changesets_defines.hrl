...
-record( creation_event, {
		   ...
		   id = undefined :: event_id() | 'undefined',


		   % A timestamp associated to the scheduling of this world event:
		   timestamp = undefined ::
			 class_TimeManager:logical_timestamp() | 'undefined',
...
% Describes the type of that association (ex: 'located_in_district').
%
% Note: 'any_association_type' is a reserved value (type wildcard), no actual
% association type shall be named as such.
%
-type association_type() :: atom().
...
-record( binary_association_event, {
		   ...
		   % that is to be associated:
		   %
		   source_external_id = undefined :: external_id() | 'undefined',


		   % The external identifier (if any) of the (target) simulation object
		   % that is to be associated:
		   %
		   target_external_id = undefined :: external_id() | 'undefined',


		   % The PID of the (source) dataflow object that is to be associated:
		   %
		   source_object_pid = undefined :: object_pid() | 'undefined',


		   % The PID of the (target) dataflow object that is to be associated:
		   %
		   target_object_pid = undefined :: object_pid() | 'undefined',


		   % Any information applying to this association.
		   %
		   association_information = undefined ::
			 association_info() | 'undefined',
...
% an output port of a dataflow object to the input port of a dataflow object.
%
-record( connection_event, {
		   ...
		   % The type (classname) of the dataflow object which is at the source
		   % endpoint of the channel.
		   %
		   source_object_type :: dataflow_object_type(),


		   % The type (classname) of the dataflow object which is at the target
		   % endpoint of the channel.
		   %
		   target_object_type :: dataflow_object_type(),


		   % The external identifier (if any) of the simulation object which is
		   % at the source endpoint of the channel.
		   %
		   source_external_id = undefined :: external_id() | 'undefined',


		   % The external identifier (if any) of the simulation object which is
		   % at the target endpoint of the channel.
		   %
		   target_external_id = undefined :: external_id() | 'undefined',



		   % The PID of the dataflow object which is at the source endpoint of
		   % the channel.
		   %
		   source_object_pid = undefined :: object_pid() | 'undefined',


		   % The PID of the dataflow object which is at the target endpoint of
		   % the channel.
		   %
		   target_object_pid = undefined :: object_pid() | 'undefined',


		   % The name of the attribute of the source dataflow object from which
		   % the channel will be created.
		   %
		   source_attribute_name :: dataflow_attribute_name(),


		   % The name of the attribute of the target dataflow object to which
		   % the channel will be created.
		   %
		   target_attribute_name :: dataflow_attribute_name(),
...
% disconnection of an output port of a dataflow object from the input port of a
% dataflow object.
%
...
% attribute they operate on:
%
-type attribute_name_match() ::
		dataflow_attribute_name() | 'any_attribute_name'.
...
-record( connection_event_match, {
		   ...
		   % If the type of the source object matters for the connection
		   % matters:
		   %
		   source_object_type_match = any_object_type :: object_type_match(),


		   % If the type of the target object matters for the connection
		   % matters:
		   %
		   target_object_type_match = any_object_type :: object_type_match(),
		   ...
		   % If the external identifier of the source object matters for the
		   % match:
		   %
		   source_external_id_match = any_external_id :: external_id_match(),


		   % If the external identifier of the target object matters for the
		   % match:
		   %
		   target_external_id_match = any_external_id :: external_id_match(),
		   ...
		   % If the (Erlang) PID of the source object matters for the match:
		   %
		   source_object_pid_match = any_object_pid :: object_pid_match(),


		   % If the (Erlang) PID of the target object matters for the match:
		   %
		   target_object_pid_match = any_object_pid :: object_pid_match(),



		   % If the attribute name of the source object matters for the match:
		   %
		   source_attribute_name_match =
			   any_attribute_name :: attribute_name_match(),


		   % If the attribute name of the target object matters for the match:
		   %
		   target_attribute_name_match =
			   any_attribute_name :: attribute_name_match(),
...
-record( disconnection_event_match, {
		   ...
		   % If the type of the source object matters for the disconnection
		   % matters:
		   %
		   source_object_type_match = any_object_type :: object_type_match(),


		   % If the type of the target object matters for the disconnection
		   % matters:
		   %
		   target_object_type_match = any_object_type :: object_type_match(),
