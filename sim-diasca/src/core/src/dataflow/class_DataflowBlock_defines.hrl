...
-record( input_port, {
		   ...
		   %
		   comment = undefined :: 'undefined' | internal_comment(),
...
-type input_port_table() :: table:table( input_port_name(), input_port() ).

% Associative table to hold output ports:
-type output_port_table() :: table:table( output_port_name(), output_port() ).



% Associative table to hold input port iterations:
-type input_iteration_table() ::
		table:table( input_iteration_name(), input_port_iteration() ).

% Associative table to hold output port iterations:
-type output_iteration_table() ::
		table:table( output_iteration_name(), output_port_iteration() ).
