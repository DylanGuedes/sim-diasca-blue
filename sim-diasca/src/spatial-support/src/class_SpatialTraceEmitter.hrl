...
% variable named 'State'.
%
-define( fatal_full( Message, MessageCategorization, SimulationTimestamp ),
		 class_TraceEmitter:send_safe( fatal, State,
				get_spatial_message( Message, State ),
				MessageCategorization, SimulationTimestamp )
...
-define( send_trace( State, Message ),
		 class_TraceEmitter:send_safe( trace, State,
						get_spatial_message( Message, State ) )
).
...
% variable named 'State'.
%
-define( trace_full( Message, MessageCategorization, SimulationTimestamp ),
		 class_TraceEmitter:send_safe( trace, State,
				get_spatial_message( Message, State ),
				MessageCategorization, SimulationTimestamp )
...
get_spatial_message( Message, State ) ->
	...
	case ?getAttr(position) of
		...
		Pos ->
			...
			Message ++ text_utils:format( "~n[while located around ~s] ",
										  [ ApproxPosString ] )
