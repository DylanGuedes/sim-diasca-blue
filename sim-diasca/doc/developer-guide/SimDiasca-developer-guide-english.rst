...
:Lastly Updated on: Tuesday, May 9, 2017
...
.. Note::
 ...
 However we require internally that the authors of any simulation element making use of Sim-Diasca's services (ex: models, simulation cases, etc.) respect at least the conventions presented in the current document, for the sake of clarity and homogeneity.
